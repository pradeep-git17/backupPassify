...
$is_expired = $current_date > $user['validity_end'];
?>
...
<body>
    ...
    <div class="container">
        ...
        <?php if ($is_expired): ?>
            <h1>Pass Expired</h1>
            <p>Your pass expired on <?php echo htmlspecialchars($user['validity_end']); ?>. Please renew your pass to continue using our services.</p>
        <?php else: ?>
            ...
            <!-- <button class="print-button" onclick="window.print()">Print Pass</button> -->
        <?php endif; ?>
    </div>
</body>
